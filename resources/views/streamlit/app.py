...
# Import page modules
from resources.views.streamlit.login_page import render as render_login  # noqa: E402
from resources.views.streamlit.dashboard_page import render as render_dashboard  # noqa: E402
from resources.views.streamlit.upload_page import render as render_upload  # noqa: E402
from resources.views.streamlit.analytics_page import render as render_analytics  # noqa: E402
from resources.views.streamlit.report_page import render as render_report  # noqa: E402
...
def _render_authenticated_app() -> None:
    ...
    if page == "dashboard":
        ...
        render_comparison(st.session_state["user_id"], st.session_state["role"])
    elif page == "admin":
        if st.session_state["role"] == "admin":
            render_admin()
        else:
